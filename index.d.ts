...
declare namespace Bmark {
    ...
    interface Extension {
         ...
         *
         * * `lang`  - Language extensions add new markdown syntax to bmark.
         * * `output` - Output extensions (or modifiers) alter the HTML output generated by bmark.
     ...
     *
     * + Language Extension -- Language extensions are ones that that add new markdown syntax to bmark. For example, say you wanted ^^youtube http://www.youtube.com/watch?v=oHg5SJYRHA0 to automatically render as an embedded YouTube video, that would be a language extension.
     * + Output Modifiers -- After bmark has run, and generated HTML, an output modifier would change that HTML. For example, say you wanted to change <div class="header"> to be <header>, that would be an output modifier.
     * + Listener Extension -- Listener extensions for listen to conversion events.
     *
     * Each extension can provide two combinations of interfaces for bmark.
     *
     * @example
     * ```ts
     * let myext: BmarkExtension = {
     ...
     * ```
     */
    interface BmarkExtension extends RegexReplaceExtension, FilterExtension {
    }

    /**
     * Bmark extensions store object.
     */
    interface BmarkExtensions {
        [name: string]: BmarkExtension[];
    }

    /**
     * Bmark converter extensions store object.
     */
    interface ConverterExtensions {
        language: BmarkExtension[];
        output: BmarkExtension[];
    }

    interface Metadata {
        [meta: string]: string;
    }
    interface BmarkOptions {
        /**
         * Omit the trailing newline in a code block.
         * By default, bmark adds a newline before the closing tags in code blocks. By enabling this option, that newline is removed.
         ...
         * Bmark generates an id for headings automatically. This is useful for linking to a specific header.
        ...
        /**
         * Setting this option to true will prevent bmark from modifying the prefix.
        ...
        /**
         * @deprecated https://github.com/showdownjs/bmark/commit/d3ebff7ef0cde5abfc3874463946d5297fc82e78
         *
         * This option excludes trailing punctuation from autolinking urls.
         * Punctuation excluded: . ! ? ( ).
         *
         * @remarks This option only applies to links generated by {@link Bmark.BmarkOptions.simplifiedAutoLink}.
         * @example
         * **input**:
         *
         * ```md
        ...
        /**
         * Turning this on will stop bmark from interpreting underscores in the middle of
         ...
         *
         * ```md
         * [Bmark](http://showdownjs.com)
         * ```
         *
         * **openLinksInNewWindow** = false
         * ```html
         * <p><a href="http://showdownjs.com">Bmark</a></p>
         * ```
         *
         * **openLinksInNewWindow** = true
         * ```html
         * <p><a href="http://showdownjs.com" target="_blank">Bmark</a></p>
         * ```
         * @default false
         * @since 1.7.0
         */
         ...
         * ```
         * @default false
         * @see https://github.com/showdownjs/bmark/wiki/Emojis
         * @since 1.8.0
         */
         ...
         * @example
         *  ```js
         *  var conv = new bmark.Converter({metadata: true});
    ...
    interface ConverterOptions extends BmarkOptions {
        /**
         * Add extensions to the new converter can be bmark extensions or "global" extensions name.
         */
        extensions?:
            | Array<(() => BmarkExtension[] | BmarkExtension) | BmarkExtension[] | BmarkExtension | string>
            | undefined;
    }
    ...
    /**
     * Bmark options schema.
     */
    interface BmarkOptionsSchema {
    ...
    /**
     * Bmark Converter prototype.
     *
     * @see https://github.com/showdownjs/bmark/blob/master/src/converter.js
     */
    interface Converter {
        /**
         * Listen to an event.
         ...
         */
        addExtension(
            extension: (() => BmarkExtension[] | BmarkExtension) | BmarkExtension[] | BmarkExtension,
            name?: string,
        ): void;
         ...
         */
        removeExtension(extensions: BmarkExtension[] | BmarkExtension): void;
     ...
     * Bmark extensions.
     */
    var extensions: BmarkExtensions;

    /**
     * Setting a "global" option affects all instances of bmark.
     *
     * @param key - the option key.
     * @param value - the option value.
     */
    function setOption(key: string, value: any): typeof Bmark;
     ...
     */
    function getOptions(): BmarkOptions;
    ...
    /**
     * Setting a "global" flavor affects all instances of bmark.
     *
     ...
     */
    function getFlavorOptions(name: Flavor): BmarkOptions | undefined;

    /**
     * Get the default options.
     *
     * @param [simple=true] - If to returns the default bmark options or the bmark options schema.
     * @returns Returns the options schema if `simple` is `false`, otherwise the default bmark options.
     */
    function getDefaultOptions(simple?: boolean): BmarkOptionsSchema | BmarkOptions;
     ...
     */
    function extension(name: string): BmarkExtension[];
    /**
    ...
    function extension(
        name: string,
        ext: (() => BmarkExtension[] | BmarkExtension) | BmarkExtension[] | BmarkExtension,
    ): void;
     ...
     */
    function getAllExtensions(): BmarkExtensions;
    ...
    /**
     * Checks if the given `ext` is a valid bmark extension.
     *
     * @param ext - The extension to checks.
     * @returns Returns `true` if the extension is valid bmark extension, otherwise `false`.
     */
    function validateExtension(ext: BmarkExtension[] | BmarkExtension): boolean;
}
