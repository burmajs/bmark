(function () {
   ...
   */
  bmark.subParser("makehtml.blockGamut", function (text, options, globals) {
    "use strict";
    ...
    // inside blockquotes
    text = bmark.subParser("makehtml.blockQuotes")(text, options, globals);
    text = bmark.subParser("makehtml.headers")(text, options, globals);

    // Do Horizontal Rules:
    text = bmark.subParser("makehtml.horizontalRule")(
      text,
      options,
      globals
    );

    text = bmark.subParser("makehtml.lists")(text, options, globals);
    text = bmark.subParser("makehtml.codeBlocks")(text, options, globals);
    text = bmark.subParser("makehtml.tables")(text, options, globals);

    // We already ran _HashHTMLBlocks() before, in Markdown(), but that
    // was to escape raw HTML in the original Markdown source. This time,
    // we're escaping the markup we've just created, so that we don't wrap
    // <p> tags around block-level tags.
    text = bmark.subParser("makehtml.hashHTMLBlocks")(
      text,
      options,
      globals
    );
    text = bmark.subParser("makehtml.paragraphs")(text, options, globals);
  ...
  bmark.subParser("makehtml.blockQuotes", function (text, options, globals) {
    "use strict";
    ...
    text = text.replace(rgx, function (bq) {
      ...
      bq = bmark.subParser("makehtml.githubCodeBlocks")(
        bq,
        options,
        globals
      );
      bq = bmark.subParser("makehtml.blockGamut")(bq, options, globals); // recurse
      ...
      return bmark.subParser("makehtml.hashBlock")(
        "<blockquote>\n" + bq + "\n</blockquote>",
        options,
        globals
      );
   ...
   */
  bmark.subParser("makehtml.codeBlocks", function (text, options, globals) {
    "use strict";
    ...
    text = text.replace(pattern, function (wholeMatch, m1, m2) {
      ...
      codeblock = bmark.subParser("makehtml.outdent")(
        codeblock,
        options,
        globals
      );
      codeblock = bmark.subParser("makehtml.encodeCode")(
        codeblock,
        options,
        globals
      );
      codeblock = bmark.subParser("makehtml.detab")(
        codeblock,
        options,
        globals
      );
      ...
      return (
        bmark.subParser("makehtml.hashBlock")(codeblock, options, globals) +
        nextChar
      );
    });
   ...
   *         ... type <code>`bar`</code> ...
   */
  bmark.subParser("makehtml.codeSpans", function (text, options, globals) {
    "use strict";
    ...
    text = text.replace(
      ...
      function (wholeMatch, m1, m2, m3) {
        ...
        c = bmark.subParser("makehtml.encodeCode")(c, options, globals);
        c = m1 + "<code>" + c + "</code>";
        c = bmark.subParser("makehtml.hashHTMLSpans")(c, options, globals);
        return c;
      }
    );
   ...
   */
  bmark.subParser("makehtml.detab", function (text, options, globals) {
    "use strict";
    text = globals.converter
  ...
  bmark.subParser("makehtml.ellipsis", function (text, options, globals) {
    "use strict";
   ...
   *
   * List of supported emojis: https://github.com/bmarkjs/bmark/wiki/Emojis
   */
  bmark.subParser("makehtml.emoji", function (text, options, globals) {
    "use strict";
    ...
    text = text.replace(emojiRgx, function (wm, emojiCode) {
      if (bmark.helper.emojis.hasOwnProperty(emojiCode)) {
        return bmark.helper.emojis[emojiCode];
      }
      return wm;
    });
  ...
  bmark.subParser(
    ...
    function (text, options, globals) {
      ...
      text = text.replace(/\\(\\)/g, bmark.helper.escapeCharactersCallback);
      text = text.replace(
        /\\([`*_{}\[\]()>#+.!~=|:-])/g,
        bmark.helper.escapeCharactersCallback
      );
   ...
   */
  bmark.subParser("makehtml.encodeCode", function (text, options, globals) {
    "use strict";
    ...
    function (text, options, globals) {
      ...
      text = text.replace(
        ...
        function (wholeMatch, delim, language, codeblock) {
          ...
          codeblock = bmark.subParser("makehtml.hashBlock")(
            codeblock,
            options,
            globals
          );
  ...
  bmark.subParser("makehtml.hashBlock", function (text, options, globals) {
    "use strict";
    text = globals.converter
  ...
  bmark.subParser(
    ...
    function (text, options, globals) {
      ...
      var repFunc = function (wholeMatch, match, left, right) {
        var codeblock =
          left +
          bmark.subParser("makehtml.encodeCode")(match, options, globals) +
          right;
        return "¨C" + (globals.gHtmlSpans.push(codeblock) - 1) + "C";
      };

      // Hash naked <code>
      text = bmark.helper.replaceRecursiveRegExp(
        text,
        repFunc,
        "<code\\b[^>]*>",
        "</code>",
  ...
  bmark.subParser("makehtml.hashElement", function (text, options, globals) {
    "use strict";
  ...
  bmark.subParser(
    ...
    function (text, options, globals) {
      ...
      for (var i = 0; i < blockTags.length; ++i) {
        ...
        while ((opTagPos = bmark.helper.regexIndexOf(text, rgx1)) !== -1) {
          // if the HTML tag is \ escaped, we need to escape it and break

          //2. Split the text in that position
          var subTexts = bmark.helper.splitAtIndex(text, opTagPos),
            //3. Match recursively
            newSubText1 = bmark.helper.replaceRecursiveRegExp(
              subTexts[1],
              repFunc,
              patLeft,
              patRight,
      ...
      text = text.replace(
        /(\n {0,3}(<(hr)\b([^<>])*?\/?>)[ \t]*(?=\n{2,}))/g,
        bmark.subParser("makehtml.hashElement")(text, options, globals)
      );
  ...
  bmark.subParser(
    ...
    function (text, options, globals) {
      ...
      text = text.replace(/<[^>]+?\/>/gi, function (wm) {
        return bmark.helper._hashHTMLSpan(wm, globals);
      });
  ...
  bmark.subParser("makehtml.headers", function (text, options, globals) {
    "use strict";
    ...
    text = text.replace(setextRegexH1, function (wholeMatch, m1) {
      var spanGamut = bmark.subParser("makehtml.spanGamut")(
          m1,
          options,
          globals
        ),
    ...
    text = text.replace(atxStyle, function (wholeMatch, m1, m2) {
      ...
      var span = bmark.subParser("makehtml.spanGamut")(
          hText,
          options,
          globals
        ),
      ...
      return bmark.subParser("makehtml.hashBlock")(header, options, globals);
    });
    ...
    function headerId(m) {
      ...
      if (bmark.helper.isString(options.prefixHeaderId)) {
  ...
  bmark.subParser(
    ...
    function (text, options, globals) {
      ...
      var key = bmark.subParser("makehtml.hashBlock")(
        "<hr />",
        options,
        globals
      );
   ...
   */
  bmark.subParser("makehtml.images", function (text, options, globals) {
    "use strict";
    ...
    function writeImageTagBaseUrl(
      ...
      url = bmark.helper.applyBaseUrl(options.relativePathBaseUrl, url);
    ...
    function writeImageTag(
      ...
      if (wholeMatch.search(/\(<?\s*>? ?(['"].*['"])?\)$/m) > -1) {
        ...
        if (!bmark.helper.isUndefined(gUrls[linkId])) {
          url = gUrls[linkId];
          if (!bmark.helper.isUndefined(gTitles[linkId])) {
            title = gTitles[linkId];
          }
          if (!bmark.helper.isUndefined(gDims[linkId])) {
      ...
      altText = altText
        .replace(/"/g, "&quot;")
        //altText = bmark.helper.escapeCharacters(altText, '*_', false);
        .replace(
          bmark.helper.regexes.asteriskDashTildeAndColon,
          bmark.helper.escapeCharactersCallback
        );
      //url = bmark.helper.escapeCharacters(url, '*_', false);
      url = url.replace(
        bmark.helper.regexes.asteriskDashTildeAndColon,
        bmark.helper.escapeCharactersCallback
      );
      ...
      if (title && bmark.helper.isString(title)) {
        title = title
          .replace(/"/g, "&quot;")
          //title = bmark.helper.escapeCharacters(title, '*_', false);
          .replace(
            bmark.helper.regexes.asteriskDashTildeAndColon,
            bmark.helper.escapeCharactersCallback
          );
  ...
  (function () {
    ...
    function writeAnchorTag(evt, options, globals, emptyCase) {
      ...
      if (emptyCase) {
        ...
        if (!bmark.helper.isUndefined(globals.gUrls[id])) {
          url = globals.gUrls[id];
          if (!bmark.helper.isUndefined(globals.gTitles[id])) {
      ...
      //url = bmark.helper.escapeCharacters(url, '*_:~', false); // replaced line to improve performance
      url = url.replace(
        bmark.helper.regexes.asteriskDashTildeAndColon,
        bmark.helper.escapeCharactersCallback
      );
      ...
      if (title !== "" && title !== null) {
        ...
        //title = bmark.helper.escapeCharacters(title, '*_', false); // replaced line to improve performance
        title = title.replace(
          bmark.helper.regexes.asteriskDashTildeAndColon,
          bmark.helper.escapeCharactersCallback
        );
      ...
      text = bmark.subParser("makehtml.codeSpans")(text, options, globals);
      text = bmark.subParser("makehtml.emoji")(text, options, globals);
      text = bmark.subParser("makehtml.underline")(text, options, globals);
      text = bmark.subParser("makehtml.italicsAndBold")(
        text,
        options,
        globals
      );
      text = bmark.subParser("makehtml.strikethrough")(
        text,
        options,
        globals
      );
      text = bmark.subParser("makehtml.ellipsis")(text, options, globals);
      text = bmark.subParser("makehtml.hashHTMLSpans")(
        text,
        options,
        globals
      );
      ...
      result = bmark.subParser("makehtml.hashHTMLSpans")(
        result,
        options,
        globals
      );
     ...
     */
    bmark.subParser("makehtml.links", function (text, options, globals) {
      text = globals.converter
        ._dispatch(evtRootName + ".start", text, options, globals)
        .getText();

      // 1. Handle reference-style links: [link text] [id]
      text = bmark.subParser("makehtml.links.reference")(
        text,
        options,
        globals
      );
      ...
      text = bmark.subParser("makehtml.links.inline")(
        text,
        options,
        globals
      );
      ...
      text = bmark.subParser("makehtml.links.referenceShortcut")(
        text,
        options,
        globals
      );
      ...
      text = bmark.subParser("makehtml.links.angleBrackets")(
        text,
        options,
        globals
      );
      ...
      text = bmark.subParser("makehtml.links.ghMentions")(
        text,
        options,
        globals
      );
      ...
      text = text.replace(/<a\s[^>]*>[\s\S]*<\/a>/g, function (wholeMatch) {
        return bmark.helper._hashHTMLSpan(wholeMatch, globals);
      });
      ...
      text = bmark.subParser("makehtml.links.naked")(text, options, globals);
      ...
      function (text, options, globals) {
        ...
        text = text.replace(
          ...
          function (wholeMatch, st, escape, mentions, username) {
            ...
            if (!bmark.helper.isString(options.ghMentionsLink)) {
    ...
    bmark.subParser(
      ...
      function (text, options, globals) {
        ...
        text = text.replace(mailRgx, function (wholeMatch, mail) {
          var url = "mailto:";
          mail = bmark.subParser("makehtml.unescapeSpecialChars")(
            mail,
            options,
            globals
          );
          if (options.encodeEmails) {
            url = bmark.helper.encodeEmailAddress(url + mail);
            mail = bmark.helper.encodeEmailAddress(mail);
          } else {
            url = url + mail;
          }
          var evt = createEvent(
   ...
   */
  bmark.subParser("makehtml.lists", function (text, options, globals) {
    "use strict";
    ...
    function processListItems(listStr, trimTrailing) {
      ...
      listStr = listStr.replace(
        ...
        function (wholeMatch, m1, m2, m3, m4, taskbtn, checked) {
          ...
          var item = bmark.subParser("makehtml.outdent")(
              m4,
              options,
              globals
            ),
          ...
          if (m1 || item.search(/\n{2,}/) > -1) {
            item = bmark.subParser("makehtml.githubCodeBlocks")(
              item,
              options,
              globals
            );
            item = bmark.subParser("makehtml.blockQuotes")(
              item,
              options,
              globals
            );
            item = bmark.subParser("makehtml.headers")(
              item,
              options,
              globals
            );
            item = bmark.subParser("makehtml.lists")(item, options, globals);
            item = bmark.subParser("makehtml.codeBlocks")(
              item,
              options,
              globals
            );
            item = bmark.subParser("makehtml.tables")(
              item,
              options,
              globals
            );
            item = bmark.subParser("makehtml.hashHTMLBlocks")(
              item,
              options,
              globals
            );
            //item = bmark.subParser('makehtml.paragraphs')(item, options, globals);
            ...
            for (var i = 0; i < end; i++) {
              ...
              if (str.search(/¨([KG])(\d+)\1/g) >= 0) {
                ...
                str = bmark.subParser("makehtml.spanGamut")(
                  str,
                  options,
                  globals
                );
            ...
            if (isParagraphed) {
              item = bmark.subParser("makehtml.paragraphs")(
                item,
                options,
                globals
              );
            } else {
              item = bmark.subParser("makehtml.spanGamut")(
                item,
                options,
                globals
              );
   ...
   */
  bmark.subParser("makehtml.metadata", function (text, options, globals) {
    "use strict";
   ...
   */
  bmark.subParser("makehtml.outdent", function (text, options, globals) {
    "use strict";
    text = globals.converter
   ...
   *
   */
  bmark.subParser("makehtml.paragraphs", function (text, options, globals) {
    "use strict";
    ...
    for (var i = 0; i < end; i++) {
      ...
      if (str.search(/¨(K|G)(\d+)\1/g) >= 0) {
        ...
        str = bmark.subParser("makehtml.spanGamut")(str, options, globals);
        str = str.replace(/^([ \t]*)/g, "<p>");
        str += "</p>";
        grafsOut.push(str);
      }
      ...
      while (/¨(K|G)(\d+)\1/.test(grafsOutIt)) {
        ...
        if (delim === "K") {
          ...
          if (codeFlag) {
            ...
            blockText = bmark.subParser("makehtml.encodeCode")(
   ...
   * tags like paragraphs, headers, and list items.
   */
  bmark.subParser("makehtml.spanGamut", function (text, options, globals) {
    "use strict";
    ...
    text = bmark.subParser("makehtml.codeSpans")(text, options, globals);
    text = bmark.subParser("makehtml.escapeSpecialCharsWithinTagAttributes")(
      text,
      options,
      globals
    );
    text = bmark.subParser("makehtml.encodeBackslashEscapes")(
      text,
      options,
      globals
    );
    ...
    text = bmark.subParser("makehtml.images")(text, options, globals);

    text = globals.converter
      ._dispatch("smakehtml.links.before", text, options, globals)
      .getText();
    text = bmark.subParser("makehtml.links")(text, options, globals);
    text = globals.converter
      ._dispatch("smakehtml.links.after", text, options, globals)
      .getText();

    //text = bmark.subParser('makehtml.autoLinks')(text, options, globals);
    //text = bmark.subParser('makehtml.simplifiedAutoLinks')(text, options, globals);
    text = bmark.subParser("makehtml.emoji")(text, options, globals);
    text = bmark.subParser("makehtml.underline")(text, options, globals);
    text = bmark.subParser("makehtml.italicsAndBold")(
      text,
    ...
    text = bmark.subParser("makehtml.strikethrough")(text, options, globals);
    text = bmark.subParser("makehtml.ellipsis")(text, options, globals);

    // we need to hash HTML tags inside spans
    text = bmark.subParser("makehtml.hashHTMLSpans")(text, options, globals);

    // now we encode amps and angles
    text = bmark.subParser("makehtml.encodeAmpsAndAngles")(
      text,
      options,
      globals
    );
    ...
    function (text, options, globals) {
      ...
      var replaceFunc = function (
        ...
        if (url.match(/^data:.+?\/.+?;base64,/)) {
          ...
          globals.gUrls[linkId] = bmark.subParser(
            "makehtml.encodeAmpsAndAngles"
  ...
  bmark.subParser("makehtml.tables", function (text, options, globals) {
    "use strict";
    ...
    function parseHeaders(header, style) {
      ...
      header = bmark.subParser("makehtml.spanGamut")(
        header,
        options,
        globals
      );
    ...
    function parseCells(cell, style) {
      var subText = bmark.subParser("makehtml.spanGamut")(
        cell,
        options,
        globals
      );
    ...
    function parseTable(rawTable) {
      ...
      for (i = 0; i < tableLines.length; ++i) {
        ...
        tableLines[i] = bmark.subParser("makehtml.codeSpans")(
          tableLines[i],
          options,
          globals
        );
      ...
      for (i = 0; i < rawHeaders.length; ++i) {
        if (bmark.helper.isUndefined(styles[i])) {
          styles[i] = "";
        }
      ...
      for (i = 0; i < rawCells.length; ++i) {
        ...
        for (var ii = 0; ii < headers.length; ++ii) {
          if (bmark.helper.isUndefined(rawCells[i][ii])) {
          }
  ...
  bmark.subParser("makehtml.underline", function (text, options, globals) {
    "use strict";
    ...
    text = text.replace(/(_)/g, bmark.helper.escapeCharactersCallback);
  ...
  bmark.subParser("makeMarkdown.blockquote", function (node, globals) {
    "use strict";
    ...
    if (node.hasChildNodes()) {
      ...
      for (var i = 0; i < childrenLength; ++i) {
        var innerTxt = bmark.subParser("makeMarkdown.node")(
          children[i],
          globals
        );
  ...
  bmark.subParser("makeMarkdown.break", function () {
    "use strict";

    return "  \n";
  });

  bmark.subParser("makeMarkdown.codeBlock", function (node, globals) {
    "use strict";
  ...
  bmark.subParser("makeMarkdown.codeSpan", function (node) {
    "use strict";

    return "`" + node.innerHTML + "`";
  });

  bmark.subParser("makeMarkdown.emphasis", function (node, globals) {
    "use strict";
    ...
    if (node.hasChildNodes()) {
      ...
      var children = node.childNodes,
        childrenLength = children.length;
      for (var i = 0; i < childrenLength; ++i) {
        txt += bmark.subParser("makeMarkdown.node")(children[i], globals);
      }
      txt += "*";
    }
    return txt;
  ...
  bmark.subParser("makeMarkdown.hr", function () {
    "use strict";

    return "---";
  });

  bmark.subParser("makeMarkdown.image", function (node) {
    "use strict";
  ...
  bmark.subParser("makeMarkdown.input", function (node, globals) {
    "use strict";
  ...
  bmark.subParser("makeMarkdown.links", function (node, globals) {
    "use strict";
  ...
  bmark.subParser("makeMarkdown.list", function (node, globals, type) {
    "use strict";
    ...
    for (var i = 0; i < listItemsLenght; ++i) {
      ...
      txt +=
        bullet +
        bmark.subParser("makeMarkdown.listItem")(listItems[i], globals);
      ++listNum;
    }
  ...
  bmark.subParser("makeMarkdown.listItem", function (node, globals) {
    "use strict";
    ...
    for (var i = 0; i < childrenLenght; ++i) {
      listItemTxt += bmark.subParser("makeMarkdown.node")(
        children[i],
        globals
      );
    }
  ...
  bmark.subParser("makeMarkdown.node", function (node, globals, spansOnly) {
    "use strict";
    ...
    if (node.nodeType === 3) {
      return bmark.subParser("makeMarkdown.txt")(node, globals);
    }
    ...
    switch (tagName) {
      ...
      case "h1":
        if (!spansOnly) {
          txt =
            bmark.subParser("makeMarkdown.header")(node, globals, 1) +
            "\n\n";
        }
        break;
      case "h2":
        if (!spansOnly) {
          txt =
            bmark.subParser("makeMarkdown.header")(node, globals, 2) +
            "\n\n";
        }
        break;
      case "h3":
        if (!spansOnly) {
          txt =
            bmark.subParser("makeMarkdown.header")(node, globals, 3) +
            "\n\n";
        }
        break;
      case "h4":
        if (!spansOnly) {
          txt =
            bmark.subParser("makeMarkdown.header")(node, globals, 4) +
            "\n\n";
        }
        break;
      case "h5":
        if (!spansOnly) {
          txt =
            bmark.subParser("makeMarkdown.header")(node, globals, 5) +
            "\n\n";
        }
        break;
      case "h6":
        if (!spansOnly) {
          txt =
            bmark.subParser("makeMarkdown.header")(node, globals, 6) +
            "\n\n";
        }
        break;
      ...
      case "p":
        if (!spansOnly) {
          txt =
            bmark.subParser("makeMarkdown.paragraph")(node, globals) +
            "\n\n";
        }
        break;
      ...
      case "blockquote":
        if (!spansOnly) {
          txt =
            bmark.subParser("makeMarkdown.blockquote")(node, globals) +
            "\n\n";
        }
        break;
      ...
      case "hr":
        if (!spansOnly) {
          txt = bmark.subParser("makeMarkdown.hr")(node, globals) + "\n\n";
        }
        break;
      ...
      case "ol":
        if (!spansOnly) {
          txt =
            bmark.subParser("makeMarkdown.list")(node, globals, "ol") +
            "\n\n";
        }
        break;
      ...
      case "ul":
        if (!spansOnly) {
          txt =
            bmark.subParser("makeMarkdown.list")(node, globals, "ul") +
            "\n\n";
        }
        break;
      ...
      case "precode":
        if (!spansOnly) {
          txt =
            bmark.subParser("makeMarkdown.codeBlock")(node, globals) +
            "\n\n";
        }
        break;
      ...
      case "pre":
        if (!spansOnly) {
          txt = bmark.subParser("makeMarkdown.pre")(node, globals) + "\n\n";
        }
        break;
      ...
      case "table":
        if (!spansOnly) {
          txt =
            bmark.subParser("makeMarkdown.table")(node, globals) + "\n\n";
        }
        break;
      ...
      //
      case "code":
        txt = bmark.subParser("makeMarkdown.codeSpan")(node, globals);
        break;

      case "em":
      case "i":
        txt = bmark.subParser("makeMarkdown.emphasis")(node, globals);
        break;

      case "strong":
      case "b":
        txt = bmark.subParser("makeMarkdown.strong")(node, globals);
        break;

      case "del":
        txt = bmark.subParser("makeMarkdown.strikethrough")(node, globals);
        break;

      case "a":
        txt = bmark.subParser("makeMarkdown.links")(node, globals);
        break;

      case "img":
        txt = bmark.subParser("makeMarkdown.image")(node, globals);
        break;

      case "br":
        txt = bmark.subParser("makeMarkdown.break")(node, globals);
        break;

      case "input":
        txt = bmark.subParser("makeMarkdown.input")(node, globals);
        break;
  ...
  bmark.subParser("makeMarkdown.paragraph", function (node, globals) {
    "use strict";
  ...
  bmark.subParser("makeMarkdown.pre", function (node, globals) {
    "use strict";
  ...
  bmark.subParser("makeMarkdown.strikethrough", function (node, globals) {
    "use strict";
  ...
  bmark.subParser("makeMarkdown.strong", function (node, globals) {
    "use strict";
  ...
  bmark.subParser("makeMarkdown.table", function (node, globals) {
    "use strict";
    ...
    for (i = 0; i < headings.length; ++i) {
      var headContent = bmark.subParser("makeMarkdown.tableCell")(
          headings[i],
          globals
        ),
        allign = "---";
    ...
    for (i = 0; i < rows.length; ++i) {
      ...
      for (ii = 0; ii < headings.length; ++ii) {
        ...
        if (typeof cols[ii] !== "undefined") {
          cellContent = bmark.subParser("makeMarkdown.tableCell")(
            cols[ii],
            globals
          );
        }
      ...
      for (ii = 0; ii < tableArray[i].length; ++ii) {
        if (i === 1) {
          if (tableArray[i][ii].slice(-1) === ":") {
            ...
            tableArray[i][ii] = bmark.helper.padEnd(
              tableArray[i][ii],
              cellSpacesCount,
              "-"
            );
  ...
  bmark.subParser("makeMarkdown.tableCell", function (node, globals) {
    "use strict";
    ...
    for (var i = 0; i < childrenLength; ++i) {
      txt += bmark.subParser("makeMarkdown.node")(
        children[i],
        globals,
        true
      );
  ...
  bmark.subParser("makeMarkdown.txt", function (node) {
    "use strict";
    ...
    txt = bmark.helper.unescapeHTMLEntities(txt);
  ...
  /**
   * bmark Converter class
   * @class
   * @param {object} [converterOptions]
   * @returns {Converter}
   */
  bmark.Converter = function (converterOptions) {
    "use strict";
    ...
    function _constructor() {
      ...
      if (options.extensions) {
        bmark.helper.forEach(options.extensions, _parseExtension);
      }
    }
    ...
    function _parseExtension(ext, name) {
      ...
      if (bmark.helper.isString(ext)) {
        ...
        if (bmark.extensions[ext]) {
          ...
          legacyExtensionLoading(bmark.extensions[ext], ext);
          return;
          // END LEGACY SUPPORT CODE
        } else if (!bmark.helper.isUndefined(extensions[ext])) {
          ext = extensions[ext];
        } else {
          throw Error(
            'Extension "' +
    ...
    this._dispatch = function dispatch(
      ...
      var event = new bmark.helper.Event(evtName, text, params);
    ...
    this.makeHtml = function (text) {
      ...
      // detab
      text = bmark.subParser("makehtml.detab")(text, options, globals);
      ...
      bmark.helper.forEach(langExtensions, function (ext) {
        text = bmark.subParser("makehtml.runExtension")(
          ext,
          text,
          options,
          globals
      ...
      // run the sub parsers
      text = bmark.subParser("makehtml.metadata")(text, options, globals);
      text = bmark.subParser("makehtml.hashPreCodeTags")(
        text,
        options,
        globals
      );
      text = bmark.subParser("makehtml.githubCodeBlocks")(
        text,
        options,
        globals
      );
      ...
      text = bmark.subParser("makehtml.hashCodeTags")(
        text,
        options,
        globals
      );
      text = bmark.subParser("makehtml.stripLinkDefinitions")(
        text,
        options,
        globals
      );
      text = bmark.subParser("makehtml.blockGamut")(text, options, globals);
      text = bmark.subParser("makehtml.unhashHTMLSpans")(
        text,
        options,
        globals
      );
      text = bmark.subParser("makehtml.unescapeSpecialChars")(
        text,
        options,
        globals
      );
      ...
      text = bmark.subParser("makehtml.completeHTMLDocument")(
        text,
        options,
        globals
      );
      ...
      bmark.helper.forEach(outputModifiers, function (ext) {
        text = bmark.subParser("makehtml.runExtension")(
          ext,
          text,
          options,
    ...
    this.makeMarkdown = function (src) {
      ...
      var doc = bmark.helper.document.createElement("div");
      doc.innerHTML = src;
      ...
      for (var i = 0; i < nodes.length; i++) {
        mdDoc += bmark.subParser("makeMarkdown.node")(nodes[i], globals);
      }
      ...
      function substitutePreCodeTags(doc) {
        ...
        for (var i = 0; i < pres.length; ++i) {
          if (
            ...
            content = bmark.helper.unescapeHTMLEntities(content);
    ...
    this.removeExtension = function (extension) {
      if (!bmark.helper.isArray(extension)) {
        extension = [extension];
      }
